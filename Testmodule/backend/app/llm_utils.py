...
PROMPT_EXAMPLES_PATH = Path(__file__).resolve().parents[1] / "prompts" / "quiz_examples.jsonl"
OOP_CONCEPTS = [
...
def generate_quiz(chapter_id: int, db, difficulty: str = "medium", question_types: list[str] | None = None):
