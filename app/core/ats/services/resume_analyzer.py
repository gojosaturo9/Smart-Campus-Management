...
from app.core.ats.models.schemas import IssueDetail
from app.core.ats.services.groq_parser import parse_resume, parse_job_description
from app.core.ats.services.jd_matcher import compare_resume_with_jd
from app.core.ats.services.feedback_engine import analyze_issues, generate_issues_summary
from app.core.ats.services.ats_scorer import calculate_overall_score, validate_skills_with_projects
...
def analyze_full_resume(
    ...
    from app.core.ats.utils.file_utils import (
